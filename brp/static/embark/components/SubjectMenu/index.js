...
class SubjectMenu extends React.Component {
    ...
    handleClick(row){
        ...
        this.props.history.push({
            pathname: 'dataentry/protocol/' + this.props.protocol.activeProtocol.id + '/subject/' + subject.id
        })
    }
...
<div>
    {
        this.props.protocol.addSubjectMode ? <NewSubjectForm orgs={this.props.protocol.orgs}/> : <div/>
    }
    {
        !this.props.protocol.addSubjectMode ? <BackButton/> : <div/>
    }
    <h3>Project: {protocol.name}</h3>
        <div id="toolbar">
            <ul className="list-unstyled">
                <li><input className="btn btn-success" onClick={this.handleNewSubject.bind(this)} type="button" value="New Subject" onclick="location.href='/portal/dataentry/protocol/20/newsubject/'" /></li>
            </ul>
        </div>
