...
RUN pip3 install "git+https://github.com/chop-dbhi/ehb-client.git@v1.0.0#egg=ehb_client"
RUN pip3 install "git+https://github.com/chop-dbhi/ehb-datasources.git@v1.0.0#egg=ehb_datasources"
